...
type Notification interface {
	SendNotification(ctx context.Context, req NotifRequest) error
}

type notificatiom struct {
}
...
func (n *notificatiom) SendNotification(ctx context.Context, req NotifRequest) error {
